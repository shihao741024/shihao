...
//    self.pickerBackgroundView.layer.borderWidth = 1.0;
    ...
    self.monthAndYearLabel.textColor = [UIColor blackColor];
...
- (IBAction)confirmDate:(id)sender {
    //TODO: Set date
    [self.delegate hsDatePickerPickedDate:[self dateWithSelectedTime] andIndex:self.index];
    [self.delegate hsDatePickerIsHidden:YES];
