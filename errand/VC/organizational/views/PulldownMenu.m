...
- (id)init
{
    ...
    cellFont = [UIFont systemFontOfSize:17];
...
- (id)initWithNavigationController:(UINavigationController *)navigationController andTitleLabel:(UILabel*)titleLabel
{
    self = [self init];
    ...
    if (self)
    {
        ...
        navigationDragGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(dragMenu:)];
//        navigationDragGestureRecognizer.minimumNumberOfTouches = 1;
//        navigationDragGestureRecognizer.maximumNumberOfTouches = 1;
        
        handleDragGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(dragMenu:)];
//        handleDragGestureRecognizer.minimumNumberOfTouches = 1;
//        handleDragGestureRecognizer.maximumNumberOfTouches = 1;
        
        [titleLabel addGestureRecognizer:navigationDragGestureRecognizer];
...
- (void)loadMenu
{
    ...
    if ([menuList respondsToSelector:@selector(setLayoutMargins:)])
    {
        [menuList setLayoutMargins:UIEdgeInsetsZero];
    }
...
{
    [self.delegate menuItemSelected:indexPath andSelectedTitle:menuItems[indexPath.row]];
}
