...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        borderColor=[UIColor colorWithWhite:0.769 alpha:1.000];
...
- (void)setupSubViewsFrame
{
    ...
    [_itemsArray enumerateObjectsUsingBlock:^(UIView *item, NSUInteger idx, BOOL *stop) {
        ...
        [self removeAllBorderView:item];
        [self addBorderView:item itemW:itemW itemH:itemH];
    }];
}

NSInteger verticalBorderTag = 214424;
NSInteger horizontalBorderVewTag = 457564;

- (void)removeAllBorderView:(UIView *)item
{
    UIView *view = [item viewWithTag:verticalBorderTag];
    view.hidden = YES;
    [view removeFromSuperview];
    
    UIView *view1 = [item viewWithTag:horizontalBorderVewTag];
    view1.hidden = YES;
    [view1 removeFromSuperview];
}

- (void)addBorderView:(UIView *)item itemW:(CGFloat)itemW itemH:(CGFloat)itemH
{
