...
- (UIColor *)hudBackgroundColor {
    ...
    return [UIColor colorWithWhite:0.941 alpha:1.000];//[UIColor colorWithWhite:0 alpha:0.8];
}
...
- (UIColor *)hudForegroundColor {
    ...
    return COMMON_LIGHT_COLOR;//[UIColor whiteColor];
}
...
- (UIColor *)hudStatusShadowColor {
    ...
    return [UIColor colorWithWhite:0.941 alpha:1.000];//[UIColor blackColor];
}
