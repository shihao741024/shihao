...
- (void)layoutSubviews{
    ...
    if (!isLayedOut){
        ...
        [bezierPath addLineToPoint:CGPointMake(0, indexHeight)];
        
        /**
         *  /
         *
         *  @param 64 64 description
         *
         *  @return return value description
         */
        letterHeight = indexHeight / 27; //self.frame.size.height / [letters count];
