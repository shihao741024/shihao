...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.tableView.backgroundColor = COMMON_BACK_COLOR;
        ...
        // 索引
        self.tableViewIndex = [[BATableViewIndex alloc] initWithFrame:(CGRect){SCREEN_WIDTH - 30,0,30,frame.size.height}];
        ...
        self.flotageLabel.backgroundColor = COMMON_BLUE_COLOR;
...
//    rect.size.height = self.tableViewIndex.indexes.count * [MyAdapter aDapter:16];
    rect.size.height = SCREEN_HEIGHT - 113 - 49;
    rect.origin.y = 0;
...
//    rect.origin.y = ([UIScreen mainScreen].bounds.size.height - rect.size.height) / 2 - 64;
